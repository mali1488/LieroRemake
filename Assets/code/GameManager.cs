...
public class GameManager : MonoBehaviour {
  ...
  IEnumerator spawn() {
    ...
    */
    ...
    player1.GetComponent<Player>().Setup("a", "d", "w", "s", "q", "e", "z", "space", "f", -140, 63, 0, 0, 0.5f, 1.0f);
    GameObject player2 = Instantiate(spawnedObject);
    player2.GetComponent<Player>().Setup("left", "right", "up", "down", "k", "l", "m", "n", "b", -120, 63, 0.5f, 0, 0.5f, 1.0f);
    yield return null;
  }
}
